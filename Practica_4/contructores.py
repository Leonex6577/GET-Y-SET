...
gaimer.get_placa_madre()
#AQUI ES SIMILAR AL DEL BANCO CREAMOS LA CLASE CON SUS VARIABLES Y DANDOLES EL VALOR QUE SERA EL MISMO PARA LOGRAR OCUPARLO CON GET Y CAMBIARLO CON SSET ASI CREAMOS UN OBJETO QUE TENGA DISTITNOS COMPONENTES EN MI CASO PARA DESPUES LOGRAR CAMBIARLO
